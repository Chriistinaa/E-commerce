...
if (isset($_POST['ajout_panier'])) { // debug($_POST);
    ...
    // Redirection vers une autre page pour éviter la double soumission
...
if (isset($_POST['payer'])) {
    ...
    if (!isset($erreur)) {
        executeRequete("INSERT INTO commande (id_membre, montant, date_enregistrement) VALUES (" . $_SESSION['utilisateur']['id_membre'] . "," . montantTotal() . ", NOW())");
        ...
        unset($_SESSION['panier']);
        mail($_SESSION['utilisateur']['email'], "confirmation de la commande", "Merci votre n° de suivi est le $id_commande", "From:vendeur@dp_site.com");
